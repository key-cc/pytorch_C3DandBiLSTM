...
class ConvLSTM(nn.Module):
    def __init__(
        self, num_classes, latent_dim=512, lstm_layers=1, hidden_dim=1024, bidirectional=False, attention=False
    ):
...
if __name__ == "__main__":
    inputs = torch.rand(20, 16, 3, 112, 112)
    net = ConvLSTM(num_classes=101)
