...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="G:\\gush_workspace\\OpenSourceDataset\\UCF-101-28frames", help="Path to UCF-101 dataset")
